...
parser.add_argument('--load_size', type=int, default=224, help='size for loading images')
parser.add_argument('--crop_size', type=int, default=224, help='size for randomly cropping images')
parser.add_argument('--image_dir', type=str, default='./data/test', help='directory for resized images')
