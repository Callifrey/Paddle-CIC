...
parser.add_argument('--model_path', type=str, default='./model2', help='path for saving trained models')
...
parser.add_argument('--result_path', type=str, default='./non_rebalance_results2', help='path for results save')
